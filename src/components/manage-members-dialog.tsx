  ...
  const addMembers = async (groupName: string, memberKeys: Array<string>) => {
    return updateMembers(
      ...
      async (groupEntries?: Array<AccessGroupEntryResponse>) => {
        const standardDerivation = deso.utils.getAccessGroupStandardDerivation(
        ...
        const accessGroupDerivation = await deso.accessGroup
          ...
          .then((res) => {
            ...
            return {
              AccessGroupPublicKeyBase58Check:
                privateKeyToDeSoPublicKey(decryptedKey),
              AccessGroupPrivateKeyHex: decryptedKey
                .getPrivate()
                .toString("hex"),
                  ...
                  (accessGroupEntry) => {
                    return {
                      ...
                      AccessGroupMemberKeyName:
                        accessGroupEntry.AccessGroupKeyName,
                      EncryptedKey:
                        encryptAccessGroupPrivateKeyToMemberDefaultKey(
        ...
        return checkTransactionCompleted(
          deso,
